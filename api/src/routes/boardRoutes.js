...
// Aplicar o middleware de autentica��o a todas as rotas de boards
...
router.post('/', async (req, res) => {
    try {
        ...
        const owner = req.user.id;  // Diretamente do usu�rio autenticado
        ...
        //talvez chamar criação de permissão aqui
